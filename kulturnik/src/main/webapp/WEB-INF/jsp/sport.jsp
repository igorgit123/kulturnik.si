...
<div class="site-wrap">
        ...
        <nav class="site-navigation text-right text-md-center" role="navigation">
            <div class="container">
                <ul class="site-menu js-clone-nav d-none d-md-block">
                    ...
                    <li class="active"><a href="sport">Šport</a></li>
    ...
    <div class="site-blocks-cover" style="background-image: url(images/sport.jpg);" data-aos="fade">
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2" style="color: white">SPORT</h1>
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.html">Domov</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Šport</strong></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12 order-2">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-5">
                            <div class="float-md-left mb-4"><h2 class="text-black h5">Šport</h2></div>
                            <div class="d-flex">
                        ...
                        <script type="text/javascript">
                            ...
                            function getbox() {
                                ...
                                jQuery.ajax({
                                    ...
                                    url: 'https://www.napovednik.com/box.php?n=10&k=428&r='+regija+'&jsoncallback=?',
